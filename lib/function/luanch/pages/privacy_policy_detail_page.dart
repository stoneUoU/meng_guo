...
class PrivacyPolicyDetailPage extends StatelessWidget {
  static const String sName = "PrivacyPolicyDetailPage";

  const PrivacyPolicyDetailPage({Key? key}) : super(key: key);
