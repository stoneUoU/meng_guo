...
const double _kDefaultLabelFontSize = 20;
const double _kDefaultUnSelectLabelFontSize = 14;
...
class ScaleTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  const ScaleTabBar({
    ...
    this.indicatorSize,
    this.labelColor,
    this.labelStyle = const TextStyle(fontSize: _kDefaultLabelFontSize),
    this.labelPadding,
    this.unselectedLabelColor,
    this.unselectedLabelStyle =
        const TextStyle(fontSize: _kDefaultUnSelectLabelFontSize),
...
class _ScaleTabBarState extends State<ScaleTabBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> wrappedTabs =
        List<Widget>.filled(widget.tabs.length, const Center());
