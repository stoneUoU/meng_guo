...
import 'extensions/tuple_extension.dart';
...
class ValueListnableTuple2Builder<T, T2> extends ValueListenableListBuilder {
  ValueListnableTuple2Builder({
    Key? key,
...
class ValueListnableTuple3Builder<T, T2, T3>
...
class ValueListnableTuple4Builder<T, T2, T3, T4>
    extends ValueListenableListBuilder {
  ValueListnableTuple4Builder({
    Key? key,
...
class ValueListnableTuple5Builder<T, T2, T3, T4, T5>
    extends ValueListenableListBuilder {
  ValueListnableTuple5Builder({
    Key? key,
...
class ValueListnableTuple6Builder<T, T2, T3, T4, T5, T6>
    extends ValueListenableListBuilder {
  ValueListnableTuple6Builder({
    Key? key,
    required Tuple6<
            ValueListenable<T>,
            ValueListenable<T2>,
...
class ValueListnableTuple7Builder<T, T2, T3, T4, T5, T6, T7>
    extends ValueListenableListBuilder {
  ValueListnableTuple7Builder({
    Key? key,
    required Tuple7<
            ValueListenable<T>,
            ValueListenable<T2>,
