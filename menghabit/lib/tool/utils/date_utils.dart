...
class BaseDateUtils {
  ...
  static String formatDataDetailsHHmm(DateTime dateTime) {
  ...
  /// 直接转换后端B日期 string->string
  static String formatBackendDateString(String? formatterDateString,
      {String? formatter = 'yyyy-MM-dd HH:mm'}) {
    if (formatterDateString != null) {
      DateTime time = DateTime.parse(formatterDateString);
