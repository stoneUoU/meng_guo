...
class CommonUtils {
      ...
      for (Match m in tags) {
        ...
        if (group != null) {
          String match = group
              ...
              .replaceAll(new RegExp("</g-emoji>"), "");
          description = description?.replaceAll(new RegExp(group), match);
        }
      }
    }
    return description;
  ...
  static Future<Null> showLoadingDialog(BuildContext context,
      {bool barrierDismissible = false, WillPopCallback? onWillPopCallback}) {
    return CommonUtils.showGSYDialog(
        context: context,
  ...
  ///显示上传loading
  static Future<Null> showUploadLoadingDialog(BuildContext context,
      {bool barrierDismissible = false, WillPopCallback? onWillPopCallback}) {
    return CommonUtils.showGSYDialog(
        context: context,
        barrierDismissible: barrierDismissible,
